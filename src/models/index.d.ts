...
export declare type Leaderboard = LazyLoading extends LazyLoadingDisabled
  ? EagerLeaderboard
  : LazyLeaderboard;

export declare const Leaderboard: (new (
  init: ModelInit<Leaderboard>
) => Leaderboard) & {
  copyOf(
    source: Leaderboard,
    mutator: (
      draft: MutableModel<Leaderboard>
    ) => MutableModel<Leaderboard> | void
  ): Leaderboard;
};
